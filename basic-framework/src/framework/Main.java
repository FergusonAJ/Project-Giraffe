...
//<editor-fold defaultstate="collapsed" desc="OpenGL Initialization">
        ...
        win = SDL_CreateWindow("Animal Bowling",40,60, 1920,1080, SDL_WINDOW_OPENGL );
    ...
    {
        curLoop = new MainMenu(win);
        curLoop.runLoop();
    }
    public static void runLoop(boolean genBasic)
    {
        
        
        curLoop = new GameLoop(win);
        if(genBasic)
        {
            curLoop.genBasic();
        }
